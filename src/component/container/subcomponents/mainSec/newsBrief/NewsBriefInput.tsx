    ...
    <div className="flex flex-col gap-3 smDT:w-[220px] mdDT:w-full">
      <div className="flex flex-col">
        ...
        <select
          ...
          className="block w-full px-3 py-2 bg-main/50 border border-main rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-point/50 focus:border-point text-sm font-paperlogy transition-all"
        >
          {Object.entries(googleNewsCategories).map(([name, keyword]) => (
            <option key={keyword} value={keyword} className="font-paperlogy">
              {name}
            </option>
          ))}
        </select>
      ...
      <div className="flex flex-col">
        ...
        <input
          ...
          className="block w-full px-3 py-2 bg-main/50 border border-main rounded-xl shadow-sm focus:outline-none focus:ring-2 focus:ring-point/50 focus:border-point text-sm font-paperlogy transition-all placeholder:text-context/50"
        />
      </div>
